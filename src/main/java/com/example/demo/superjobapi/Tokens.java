...
@Slf4j
public class Tokens {
    public static String getTokens(String login, String password) throws IOException {
    ...
    public static String getFavsList(String login, String password) throws IOException{
